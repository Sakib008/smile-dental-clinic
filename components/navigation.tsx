      ...
      >
        <div
          className={`glass rounded-full px-6 py-3 flex items-center justify-between transition-all duration-300 ${
            isScrolled
              ? "shadow-lg bg-white/80 dark:bg-black/80"
              : "bg-white/50 dark:bg-black/50 border-transparent shadow-none"
          }`}
        >
          ...
          <div className="hidden md:flex items-center space-x-3">
            ...
            <Button
              asChild
              size="sm"
              className="bg-gradient-to-r from-royal to-teal hover:from-royal-dark hover:to-teal-dark text-white rounded-full shadow-md hover:shadow-lg transition-all duration-300"
            >
          ...
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetContent
              side="right"
              className="w-[300px] sm:w-[400px] glass border-l border-white/20"
            >
              <nav className="flex flex-col space-y-6 mt-10">
                ...
                <div className="flex flex-col space-y-4 pt-6 border-t border-border">
                  ...
                  <Button
                    asChild
                    className="bg-gradient-to-r from-royal to-teal text-white rounded-full w-full shadow-md"
                  >
                    <Link
